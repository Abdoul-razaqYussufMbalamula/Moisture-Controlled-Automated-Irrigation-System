...
Data Logging: Initiated continuous serial monitoring of the ADC values to observe how the sensors reacted in real-time.

Environmental Validation and Testing: Subjected the sensors to highly controlled, iterative physical tests. I manually adjusted the hydration levels of the specific soil being used and mapped the corresponding hardware response curves.

Firmware Calibration: Discarded theoretical parameters and updated the firmware with empirically validated threshold bands (e.g., locking the activation window strictly between the analog values of 600-800). This manual validation stabilized the logic loop and ensured reliable field operation.
